  ...
  return (
    <label className="flex items-center gap-2 text-sm text-text-muted">
      <span className="relative flex h-4 w-4 flex-none items-center justify-center">
        ...
        />
        <span className="pointer-events-none absolute inset-0 rounded-full border-2 border-text-subtle backdrop-blur-[1px] transition-colors duration-300 peer-checked:border-primary peer-checked:bg-primary/15" />
        <svg
          width="9"
          height="9"
          viewBox="0 0 24 24"
