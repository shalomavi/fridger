    ...
    >
      {toasts.map((toast) => (
        <button
          ...
          className={`animate-toast-in pointer-events-auto w-full max-w-md overflow-hidden rounded-xl bg-surface/50 text-text shadow-lg ring-1 ring-inset ring-surface-muted/60 backdrop-blur-md transition-transform duration-300 active:scale-95 ${
