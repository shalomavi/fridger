...
function MeatIcon({ className }: { className?: string }) {
  ...
  // hand-approximated — user-supplied source, not Lucide. Filled shape at
  // its own 512-unit viewBox, unlike this file's usual 24-unit stroke icons.
  return (
    <svg width={16} height={16} viewBox="0 0 512 512" fill="currentColor" aria-hidden className={className}>
      <path d="M110.26,202.977c-4.636-3.246-10.289-5.311-16.284-5.303c-6.003-0.008-11.664,2.057-16.3,5.303
      ...
      <path d="M512,223.221c0-17.105-6.963-32.729-18.204-43.93c-11.176-11.208-26.808-18.203-43.922-18.187
...
function PantryIcon({ className }: { className?: string }) {
  // Traced from a downloaded reference SVG (a stocked cabinet), simplified
  // to a bare shelf grid — the source's per-item illustrations (cans,
  // produce, jars...) don't read at this size.
  return (
    <svg {...SHARED_PROPS} className={className}>
