...
function FrozenIcon({ className }: { className?: string }) {
  return (
    <svg {...SHARED_PROPS} className={className}>
      ...
      <path d="M9.8 3.8 12 2 14.2 3.8" />
      <path d="M9.8 20.2 12 22 14.2 20.2" />
      <path d="M6.2 3.66 4.93 4.93 3.66 6.2" />
      <path d="M20.34 17.8 19.07 19.07 17.8 20.34" />
      <path d="M20.34 6.2 19.07 4.93 17.8 3.66" />
      <path d="M6.2 20.34 4.93 19.07 3.66 17.8" />
    </svg>
  )
}
