...
export const fieldClass =
  'rounded-lg bg-surface/5 text-text outline-none shadow-[inset_0_-2px_0_rgba(0,0,0,0.35),0_2px_4px_rgba(0,0,0,0.3),0_12px_32px_rgba(0,0,0,0.4)] backdrop-blur-xl backdrop-saturate-150 focus:ring-2 focus:ring-primary'
